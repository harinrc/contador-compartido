...
Contador colaborativo en tiempo real para equipos. Permite crear varios contadores, aumentar o retroceder el valor, iniciar sesión e invitar a otras cuentas por correo.
